...
function retweet() {
    var params = {
        q: '"#starfrosch min_retweets:2 min_faves:2" OR "#hot111 min_retweets:2 min_faves:2" OR "#ccmusic min_retweets:3 min_faves:3" -from:markwinder8 -from:eii_ccmusic',  // REQUIRED
        result_type: 'recent',
        lang: 'en'
    };
